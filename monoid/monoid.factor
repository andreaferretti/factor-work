...
USING: accessors arrays assocs generalizations hashtables kernel
  math quotations sequences stack-checker strings ;
IN: monoid
...
M: quotation |+| dup infer in>> length [ nbi |+| ] 3curry ;
